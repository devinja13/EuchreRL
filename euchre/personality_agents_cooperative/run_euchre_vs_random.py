...
# QMIX-trained agents (team 0&2) vs Random agents (team 1&3).
...
agents = [agent0, RandomAgent(54), agent2, RandomAgent(54)]
...
print(f'  QMIX team   (players 0 & 2): {total_payoffs[0] + total_payoffs[2]}')
print(f'  Random team (players 1 & 3): {total_payoffs[1] + total_payoffs[3]}')
